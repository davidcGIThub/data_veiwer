...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(self.graph2Widget,1,0)
        layout.addWidget(self.graph3Widget,2,1)
        ...
        self.data2_line =  self.graph2Widget.plot(self.x2, self.y2, pen=pen)
        self.data3_line =  self.graph3Widget.plot(self.x3, self.y3, pen=pen)
